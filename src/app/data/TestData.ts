// тестовые данные в виде массивов (заменяет таблицы БД)
...
export class TestData {
  ...
  static tasks: Task[] = [
    ...
    {
      id: 4,
      title: 'Сходить в парк с семьёй и пригласить друзей',
    ...
    {
      id: 5,
      title: 'Найти и выучить учебник поквантовой физике',
      completed: false,
      category: TestData.categories[2]
    },
    {
      id: 6,
      title: 'Сходить на семинар по программировнию',
      priority: TestData.priorities[1],
      completed: true,
      category: TestData.categories[2],
    ...
    {
      id: 7,
      title: 'Найти билеты вв турцию, выбрать отель',
      priority: TestData.priorities[2],
      completed: false,
    ...
    {
      id: 12,
      title: 'Сходить на лекцию "Как научиться програмировать на Java"',
      priority: TestData.priorities[1],
      completed: false,
      category: TestData.categories[2]
    },
